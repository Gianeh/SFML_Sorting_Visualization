...
g++ source.cpp Controller.cpp PlayGround.cpp Screen.cpp Data.cpp Algorithms.cpp Utility.cpp -I /mnt/c/Users/pietr/OneDrive/Desktop/C++/PROGETTO/SFML-2.5.1/include -l sfml-system -l sfml-graphichs -l sfml-window -std=c++11 -o exe  
